...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            else
            {
                ...
                EventPostMotionUpdate eventPostMotion = new EventPostMotionUpdate();
    ...
    {
    	EventPreMotionUpdate eventPreMotion = new EventPreMotionUpdate(this.rotationYaw, this.rotationPitch, this.onGround, this.posX, this.posY, this.posZ);
    	eventPreMotion.call();
        ...
        if (flag != this.isServerSprintState())
        {
            if (flag)
            {
            ...
            this.setServerSprintState(flag);
        }
        ...
        {
            double d0 = eventPreMotion.x- this.lastReportedPosX;
            double d1 = this.getEntityBoundingBox().minY - this.lastReportedPosY;
            double d2 = eventPreMotion.z - this.lastReportedPosZ;
            ...
            if (this.ridingEntity == null)
            {
                if (flag2 && flag3)
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(eventPreMotion.x, this.getEntityBoundingBox().minY, eventPreMotion.z, eventPreMotion.getYaw(), eventPreMotion.getPitch(), eventPreMotion.onGround()));
                }
                else if (flag2)
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(eventPreMotion.x, this.getEntityBoundingBox().minY, eventPreMotion.z, eventPreMotion.onGround()));
                }
                else if (flag3)
                {
            ...
            {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0D, this.motionZ, eventPreMotion.getYaw(), eventPreMotion.getPitch(), eventPreMotion.onGround()));
                flag2 = false;
            }
            ...
            if (flag2)
            {
                this.lastReportedPosX = eventPreMotion.x;
                this.lastReportedPosY = this.getEntityBoundingBox().minY;
                this.lastReportedPosZ = eventPreMotion.z;
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding())
        {
        	...
        	EventSlowDown event = new EventSlowDown(strafeMultiplier, forwardMultiplier);
        	event.call();
        	if (!event.isCancelled()) {
        		
                strafeMultiplier = event.strafeMultiplier;
                forwardMultiplier = event.forwardMultiplier;
