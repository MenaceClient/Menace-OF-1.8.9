...
import dev.menace.utils.misc.security.GuiBetaLogin;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
	...
	private void startGame() throws LWJGLException, IOException
	{
		...
		else
		{
			...
			if (Menace.instance.beta) {

				File betaKey = new File(FileManager.getBetaFolder(), "beta.json");

				if (FileManager.readFromJson(betaKey, String.class) == null) { 
					this.displayGuiScreen(new GuiBetaLogin());
				} else {

					String sha256hex = Hashing.sha256()
							.hashString(FileManager.readFromJson(betaKey, String.class), StandardCharsets.UTF_8)
							.toString();
	...
	public void clickMouse()
	{
		...
		EventLeftClick eventLeftClick = new EventLeftClick();
		eventLeftClick.call();
