...
import dev.menace.module.modules.combat.KillAura;
import dev.menace.module.modules.render.Animations;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        animations = Menace.instance.moduleManager.animationsModule;
        ...
        if (this.itemToRender != null) {
            final KillAura killAura = Menace.instance.moduleManager.killAuraModule;

            if (this.itemToRender.getItem() instanceof ItemMap) {
                this.renderItemMap(abstractclientplayer, f2, f, f1);
            } else if ((abstractclientplayer.isUsingItem() || (mc.gameSettings.keyBindDrop.isKeyDown() && animations.getAnythingBlock())) || ((itemToRender.getItem() instanceof ItemSword || animations.getAnythingBlock())
                    && killAura.blocking || mc.thePlayer.isBlocking())) {
                switch((killAura.blocking || mc.thePlayer.isBlocking() || animations.getAnythingBlock()) ? EnumAction.BLOCK : this.itemToRender.getItemUseAction()) {
                    case NONE:
                        this.transformFirstPersonItem(f, 0.0F);
                        break;
                    case EAT:
                    ...
                    case BLOCK:
                        if(animations.isToggled()){
                            GL11.glTranslated(animations.getTranslateX(), animations.getTranslateY(), animations.getTranslateZ());
                            
                            if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("Avatar")) {
                                avatar(f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("Akrien")) {
                            	 transformFirstPersonItem(f1, 0.0F);
                                 doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("ETB")) {
                            	etb(f, f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("Exhibition")) {
                                ...
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("Push")) {
                            	push(f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("Reverse")) {
                            	transformFirstPersonItem(f1, f1);
                                doBlockTransformations();
                                GlStateManager.rotate(0.0F, 1.0F, 0.0F, 0.0F);
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("Shield")) {
                            	jello(f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("SigmaNew")) {
                            	sigmaNew(0.2F, f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("SigmaOld")) {
                            	sigmaOld(f);
                            ...
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("Slide")) {
                            	slide(f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("SlideDown")) {
                            	transformFirstPersonItem(0.2F, f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("Swong")) {
                                ...
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("VisionFX")) {
                            	continuity(f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("Swank")) {
                                ...
                                this.doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("Jello")) {
                            ...
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("HSlide")) {
                            	transformFirstPersonItem(f1!=0?Math.max(1-(f1*2),0)*0.7F:0, 1F);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("None")) {
                            	transformFirstPersonItem(0F,0F);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getString().equalsIgnoreCase("1.7")) {
                ...
                if (!(animations.isToggled()&&animations.getSwingAnim()))
                    this.doItemUsedTransformations(f1);
                this.transformFirstPersonItem(f, f1);
            }
    ...
    private void doItemRenderGLTranslate(){
        if(animations.isToggled()) {
            GlStateManager.translate(animations.getItemPosX(), animations.getItemPosY(), animations.getItemPosZ());
        }else{
            GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
        }
    }
    ...
    private void doItemRenderGLRotate() {
        if(animations.isToggled()) {
        	GlStateManager.rotate((float) animations.getItemRotation(), 0.0F, 1.0F, 0.0F);
        }else{
        	GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
        }
    }
