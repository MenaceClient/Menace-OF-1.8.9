...
import dev.menace.utils.render.glu.CachetessCallback;
import dev.menace.utils.render.glu.DirectTessCallback;
import dev.menace.utils.render.glu.VertexData;
...
public final class RenderUtils {
    ...
    public static void drawVape(final int posX, final int posY, final int scale, final EntityLivingBase entity) {
        GlStateManager.pushMatrix();
        GlStateManager.enableColorMaterial();
