package dev.menace.gui.clickgui.herocode.clickgui.elements;
...
import dev.menace.gui.clickgui.herocode.clickgui.Panel;
import dev.menace.gui.clickgui.herocode.clickgui.elements.menu.ElementCheckBox;
import dev.menace.gui.clickgui.herocode.clickgui.elements.menu.ElementComboBox;
import dev.menace.gui.clickgui.herocode.clickgui.elements.menu.ElementSlider;
	...
	public ModuleButton(Module imod, Panel pl) {
		...
		for (Setting s : mod.settings) {
			if (s instanceof BoolSetting) {
				menuelements.add(new ElementCheckBox(this, (BoolSetting) s));
			} else if (s instanceof DoubleSetting) {
				menuelements.add(new ElementSlider(this, (DoubleSetting) s));
			} else if (s instanceof StringSetting) {
				menuelements.add(new ElementComboBox(this, (StringSetting) s));
			}
		}
	}
	...
	public boolean mouseClicked(int mouseX, int mouseY, int mouseButton) {
		...
		if (mouseButton == 0) {
			...
			if (menuelements != null && menuelements.size() > 0) {
				...
				Menace.instance.moduleManager.clickGuiModule.heroClickGui.closeAllSettings();
				this.extended = b;
