package dev.menace.gui.clickgui.herocode.clickgui;
...
public class Panel {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(!Menace.instance.moduleManager.clickGuiModule.design.getString().equalsIgnoreCase("JellyLike")){
		...
		}else if(Menace.instance.moduleManager.clickGuiModule.design.getString().equalsIgnoreCase("JellyLike")){
		...
		if (this.extended && !Elements.isEmpty()) {
			...
			int epanelcolor = !Menace.instance.moduleManager.clickGuiModule.design.getString().equalsIgnoreCase("JellyLike") ? 0xff232323 : Menace.instance.moduleManager.clickGuiModule.design.getString().equalsIgnoreCase("JellyLike") ? 0xbb151515 : 0;;
