...
public class Slider extends Component {
	...
	public Slider(DoubleSetting value, Button button, int offset) {
		this.val = value;
		this.parent = button;
	...
	public void renderComponent() {
		...
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.val.getName() + ": " + String.format(this.val.getName() + ":  %.2f", this.val.getValue()), (parent.parent.getX()* 2 + 15), (parent.parent.getY() + offset + 2) * 2 + 5, -1);
