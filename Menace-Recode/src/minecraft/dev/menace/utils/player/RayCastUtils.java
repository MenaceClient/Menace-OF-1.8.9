...
public class RayCastUtils
{
    ...
    public static MovingObjectPosition getMouseOver(final float yaw, final float pitch, final float range) {
        ...
        final Entity var2 = RayCastUtils.mc.getRenderViewEntity();
        if (var2 != null && RayCastUtils.mc.theWorld != null) {
            double var3 = RayCastUtils.mc.playerController.getBlockReachDistance();
            MovingObjectPosition objectMouseOver = var2.rayTrace(var3, 1.0f);
            double var4 = var3;
            final Vec3 var5 = var2.getPositionEyes(1.0f);
            var3 = range;
            var4 = range;
            ...
            final List var10 = RayCastUtils.mc.theWorld.getEntitiesWithinAABBExcludingEntity(var2, var2.getEntityBoundingBox().addCoord(var6.xCoord * var3, var6.yCoord * var3, var6.zCoord * var3).expand(1.0, 1.0, 1.0));
            double var11 = var4;
