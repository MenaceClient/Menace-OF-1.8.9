...
public class FrameCategory implements Priority {
    ...
    public void drawScreen(int mouseX, int mouseY)
    {
        ...
        Minecraft.getMinecraft().fontRendererObj.drawString(category.name(), x + 3, y + ((categoryNameHeight / 2F) - Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT / 2F), stringColor, true);
