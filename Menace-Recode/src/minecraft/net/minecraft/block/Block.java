...
public class Block
{
    ...
    return true;
    if(Menace.instance.moduleManager.xrayModule.isToggled())
    return false;
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity)
    {
        ...
        EventCollide eventCollide = new EventCollide(pos.getX(), pos.getY(), pos.getZ(), axisalignedbb, this, collidingEntity);
        eventCollide.call();
    ...
    public AxisAlignedBB getCollisionBoundingBox(World worldIn, @NotNull BlockPos pos, IBlockState state)
    {
        return new AxisAlignedBB((double)pos.getX() + this.minX, (double)pos.getY() + this.minY, (double)pos.getZ() + this.minZ, (double)pos.getX() + this.maxX, (double)pos.getY() + this.maxY, (double)pos.getZ() + this.maxZ);
    }
