...
public class C0BPacketEntityAction implements Packet<INetHandlerPlayServer>
{
    ...
    {
        buf.writeVarIntToBuffer(this.getEntityID());
    ...
    public void setAction(C0BPacketEntityAction.Action action) {
    	this.action = action;
    }
