...
import dev.menace.module.modules.render.AnimationsModule;
...
public class ItemRenderer
{
    ...
    private AnimationsModule animations;
                ...
                switch((mc.thePlayer.isBlocking() || animations.getAnythingBlock()) ? EnumAction.BLOCK : this.itemToRender.getItemUseAction()) {
                    ...
                    case BLOCK:
                        if(animations.isToggled()){
                            ...
                            if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("Avatar")) {
                                avatar(f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("Akrien")) {
                            	 transformFirstPersonItem(f1, 0.0F);
                                 doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("ETB")) {
                            	etb(f, f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("Exhibition")) {
                                ...
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("Push")) {
                            	push(f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("Reverse")) {
                            	transformFirstPersonItem(f1, f1);
                                doBlockTransformations();
                                GlStateManager.rotate(0.0F, 1.0F, 0.0F, 0.0F);
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("Shield")) {
                            	jello(f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("SigmaNew")) {
                            	sigmaNew(0.2F, f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("SigmaOld")) {
                            	sigmaOld(f);
                            ...
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("Slide")) {
                            	slide(f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("SlideDown")) {
                            	transformFirstPersonItem(0.2F, f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("Swong")) {
                                ...
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("VisionFX")) {
                            	continuity(f1);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("Swank")) {
                                ...
                                this.doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("Jello")) {
                            ...
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("HSlide")) {
                            	transformFirstPersonItem(f1!=0?Math.max(1-(f1*2),0)*0.7F:0, 1F);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("None")) {
                            	transformFirstPersonItem(0F,0F);
                                doBlockTransformations();
                            } else if (Menace.instance.moduleManager.animationsModule.blockMode.getValue().equalsIgnoreCase("1.7")) {
